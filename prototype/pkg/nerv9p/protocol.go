// Package nerv9p implements the 9P2000 protocol for LLM agent namespaces.
//
// This is a minimal, clean implementation focused on the subset of 9P
// needed for agent-service interaction. It is designed to be:
//   - Zero external dependencies (stdlib only)
//   - LLM-friendly (self-describing, good errors)
//   - Easy to bridge with MCP servers
//
