...
│   ├── main-arxiv.tex         # Canonical LaTeX source (arXiv layout)
│   ├── main-acm.tex           # ACM journal layout, generated by make-acm.py
│   ├── main-acm-supp.tex      # Supplementary material (generated)
│   ├── make-acm.py            # Generates the ACM files from main-arxiv.tex
